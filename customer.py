...
class Cust_Win:
    def __init__(self, root):
        ...
        self.root.geometry("1295x580+230+220")
         ...
         # ==================================== title ============================================================
        lbl_title = Label(self.root, text="ADD CUSTOMER DETAILS", font=("times new roman", 18, "bold"), bg="black", fg="gold", bd=4, relief=Tk.RIDGE)
        ...
        lbl_logo = tk.Label(self.root, image=self.photoimg2, bd=0, relief=tk.RIDGE)
        ...
        enty=ref=ttk.Entry(labelframeleft,width==29,font=("times new roman", 13, "bold"))
        enty_ref.grid(row=0,column=1)

        # cust name
        cname=Label1(labelframeleft,font=("arial",12,"bold"),text="Customer Name:",padx=2,pady=6)
        ...
        # gender combox
        label_gender=Label1(labelframeleft,font=("arial",12,"bold"),text="Gender:",padx=2,pady=6)
        ...
        self.Cust_Details_Table.heading("ref",text="Refer No",width=100)
        self.Cust_Details_Table.heading("name",text="Name",width=100)
        self.Cust_Details_Table.heading("mother",text="Mother Name",width=100)
        self.Cust_Details_Table.heading("gender",text="Gender",width=100)
        self.Cust_Details_Table.heading("post",text="PostCode",width=100)
        self.Cust_Details_Table.heading("mobile",text="Mobile",width=100)
        self.Cust_Details_Table.heading("email",text="Email",width=100)
        self.Cust_Details_Table.heading("nationality",text="Nationality",width=100)
        self.Cust_Details_Table.heading("idproof",text="Id Proof",width=100)
        self.Cust_Details_Table.heading("idnumber",text="Id Number",width=100)
        self.Cust_Details_Table.heading("address",text="Address",width=100)
