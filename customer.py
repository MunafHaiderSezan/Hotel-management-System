...
class Cust_Win:
       ...
       if self.var_mobile.get()=="" or self.var_mother.get()=="":
        messagebox.showerror("Error","All fields are required",parent=self.root)
          ...
          try:
              ...
              my_cursor.execute("inser into customer values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,)",(
                                                                        self.var_ref.get(),
            ...
            self.fetch_data()
            conn.close()
            messagebox.showinfo("Success","customer has been added",paren=self.root)
    ...
    def get_cursor(self,event="")
        cursor_rowself.Cust_Details_Table.focus()
    ...
    def update(self):
        ...
        self.fetch_data()
        conn.close()
        messagebox.showinfo("Update","Customer details has benn updated successfully",parent=self.root)
    def mDelete(self):
